/******************************************************************************
 ...
 Description    : 引脚和外设使能初始化函数
 ------------------------------------------------------------------------------
 Modification History:
 <No.>  <version>       <time>      <author>        <contents>
   3、    2.00        2011-06-16      LFG            显示终端管脚配置
   2、    1.01        2010-08-19      LFG            添加了5463的中断脚和片选脚配置,
...
#else
    PINMODE_OD0 = (P0_SDA_E2 | P0_SCL_E2 | P0_SDA_LCD | P0_SCL_LCD);        //设置引脚开漏模式
#endif
    PINMODE_OD1 = 0;
    PINMODE_OD2 = 0;
    PINMODE_OD3 = 0;
