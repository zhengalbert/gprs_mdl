/******************************************************************************
 ...
 File Name      : lpc1700.h
 Description    : lpc1700寄存器地址定义
 ------------------------------------------------------------------------------
 Modification History:
 <No.>  <version>       <time>      <author>        <contents>
   2、	  1.01		  2010-08-20	  LFG			添加总中断开关宏定义
   1、    1.00        2010-07-19      snap           the original version（2009-07-24增加中断优先级定义版本）
******************************************************************************/
...
#define LPC_NVIC                    (*(volatile unsigned long *)0xE000E004)//AZH 110512 与core_cm3.h重复定义
...
#define DMACC3LLI               (*(volatile unsigned long *)0x50004168)
...
#define DMACC5DestAddr          (*(volatile unsigned long *)0x500041A4)
...
#define ICER0                CLRENA0								    //LFG2010.8.20添加，为了跟文档保持一致
#define ISER0				 SETENA0									//LFG2010.8.20添加，为了跟文档保持一致
